...
async function fetchJogos() {
  ...
  for (const match of manualLibertadores.matches) {
    ...
    const defaultGuest = 'aline.1.ribeiro@gmail.com'; // Altere para o e-mail que desejar
    const calendarLink = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${textCal}&dates=${dataFormatadaCale}/${dataFormatadaCale}&add=${defaultGuest}`;
